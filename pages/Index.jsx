  ...
  render() {
    return (
      <div styles={[BaseStyles.container, { padding: '60px 0' }]}>
        ...
        <h5>Pearl Coffee <em>(June 2013 - Present)</em></h5>
        <ul>
        ...
        <h5>Life Time Fitness <em>(April 2014 - Present)</em></h5>
        <ul>
        ...
        <h5>SpyFu <em>(May 2011 - April 2014)</em></h5>
        <ul>
        ...
        <h5>Universal UClick <em>(July 2010 - May 2011)</em></h5>
        <ul>
